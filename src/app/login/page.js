...
export default function LoginPage() {
  ...
  const { login, profile, user, checkUser } = useLeadStore();
    ...
    <div style={{ height: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "var(--bg-primary)" }}>
      <div style={{ width: "100%", maxWidth: "400px", padding: "2rem", background: "var(--bg-secondary)", borderRadius: "var(--radius-lg)", border: "1px solid var(--border-color)", boxShadow: "0 10px 25px rgba(0,0,0,0.5)" }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <input 
                ...
                required 
                placeholder="admin@qubix.agency"
              />
            </div>
          </div>
          ...
          <button type="submit" className="btn btn-primary" style={{ width: "100%", padding: "0.75rem", marginTop: "0.5rem", justifyContent: "center" }} disabled={loading}>
